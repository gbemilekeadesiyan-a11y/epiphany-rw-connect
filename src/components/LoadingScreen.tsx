...
const LoadingScreen = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-primary via-primary to-primary/80 flex flex-col items-center justify-center">
      ...
      <div className="relative z-10">
        <svg 
          ...
          viewBox="0 0 166 202"
          className="w-48 h-48 text-gold animate-[fade-in-out_2s_ease-in-out_infinite]"
        >
          <path 
